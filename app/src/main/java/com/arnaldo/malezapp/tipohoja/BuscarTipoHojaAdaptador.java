...
public class BuscarTipoHojaAdaptador extends RecyclerView.Adapter implements View.OnClickListener {
    private Context context;
    private ArrayList<BuscarTipoHojaItem> listItems; //Aca se cargaran los datos
    ...
    public BuscarTipoHojaAdaptador(Context context, ArrayList<BuscarTipoHojaItem> listItems) {
        this.context = context;
        this.listItems = listItems;
    }

    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View vista = LayoutInflater.from(context).inflate(R.layout.buscar_tipohoja_adaptador, null, false);
        //OnClick
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder rvviewHolder, int position) {
        BuscarTipoHojaItem item = listItems.get(position);
