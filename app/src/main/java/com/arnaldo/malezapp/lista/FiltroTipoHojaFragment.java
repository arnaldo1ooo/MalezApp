...
public class FiltroTipoHojaFragment extends Fragment {
    ...
    public FiltroTipoHojaFragment() {
        // Required empty public constructor
    }

    public static FiltroTipoHojaFragment newInstance(String param1, String param2) {
        FiltroTipoHojaFragment fragment = new FiltroTipoHojaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String tipohojaSelect = ((ListaActivity) getActivity()).tipoHojaSelect;
